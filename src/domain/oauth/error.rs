...
impl OAuth2Error {
    pub fn error_code(&self) -> &'static str {
        match self {
            OAuth2Error::InvalidClient | OAuth2Error::InvalidClientCredentials => "invalid_client",
            OAuth2Error::ClientDisabled | OAuth2Error::UnauthorizedClient(_) => {
                "unauthorized_client"
            }
    ...
    pub fn http_status(&self) -> u16 {
        match self {
            OAuth2Error::InvalidClient | OAuth2Error::InvalidClientCredentials => 401,
            OAuth2Error::AppDisabled
            | OAuth2Error::UserNotAuthenticated
    ...
    pub fn needs_www_authenticate(&self) -> bool {
        matches!(
            self,
            OAuth2Error::InvalidClient | OAuth2Error::InvalidClientCredentials
        )
    }
}
