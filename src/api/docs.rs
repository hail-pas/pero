...
#[openapi(
    ...
    components(
        schemas(
            ...
            crate::domain::user::models::UserDTO,
            crate::domain::user::models::RegisterRequest,
            crate::domain::user::models::CreateUserRequest,
            crate::domain::user::models::UpdateUserRequest,
            crate::domain::user::models::UpdateMeRequest,
            crate::domain::user::models::LoginRequest,
            crate::domain::user::models::TokenResponse,
            crate::domain::user::models::RefreshRequest,
            crate::domain::user::models::BindRequest,
            crate::domain::user::models::ChangePasswordRequest,
            crate::domain::credential::entity::Identity,
            crate::domain::user::dto::UserAttribute,
            crate::domain::user::dto::SetAttributes,
            crate::domain::app::models::AppDTO,
            crate::domain::app::models::CreateAppRequest,
            crate::domain::app::models::UpdateAppRequest,
            crate::domain::oauth::models::OAuth2ClientDTO,
            crate::domain::oauth::models::CreateClientRequest,
            crate::domain::oauth::models::CreateClientResponse,
            crate::domain::oauth::models::UpdateClientRequest,
            crate::domain::oauth::models::TokenRequest,
            crate::domain::oauth::models::TokenResponse,
            crate::domain::oauth::models::RevokeRequest,
            crate::domain::oauth::models::AuthorizeQuery,
            ...
            crate::domain::federation::entity::SocialProviderPublic,
            crate::domain::federation::entity::SocialProviderDTO,
            crate::domain::federation::entity::CreateSocialProviderRequest,
            crate::domain::federation::entity::UpdateSocialProviderRequest,
        )
    ),
    tags(
